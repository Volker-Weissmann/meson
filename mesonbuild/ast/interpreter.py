...
if T.TYPE_CHECKING:
    ...
    from ..interpreterbase import TYPE_nkwargs, TYPE_nvar, TYPE_var, TYPE_kwargs
    from ..mparser import (
        AndNode,
        ComparisonNode,
        ForeachClauseNode,
...
class AstInterpreter(InterpreterBase):
    ...
    def get_cur_value(self, var_name: str, allow_none: bool = False) -> T.Union[BaseNode, UnknownValue]:
        if var_name in set(['meson', 'host_machine', 'build_machine', 'target_machine']):
            return UnknownValue()
        ret = None
