...
if T.TYPE_CHECKING:
    ...
    from ..mesonlib import FileOrString, File
...
class Dependency(HoldableObject):
    ...
    def get_sources(self) -> T.Sequence[T.Union['File', 'CustomTarget', 'StructuredSources']]:
...
class InternalDependency(Dependency):
    def __init__(self, version: str, incdirs: T.List['IncludeDirs'], compile_args: T.List[str],
                 ...
                 sources: T.Sequence[T.Union[File, CustomTarget, StructuredSources]],
